...
| R10 | Código, link de acesso e aparelho confiável | expiração + 7 dias | eliminar | `auth_cleanup` FIXA os 7 dias: `--days` com qualquer outro valor recusa antes de tocar em dado. Continua sem agendamento — quem o chama é operação, não worker |
