...
2. Abrir `/admin/operacao/pedidos/`, `/admin/operacao/kds/<ref>/`, `/admin/operacao/fechamento/`, `/gestor/pos/` e `/gestor/producao/kds/`. (A produção é o Produção, `surfaces/production-nuxt`; auditar lá.)
