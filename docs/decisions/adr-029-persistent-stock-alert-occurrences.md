...
- `production_ready` usa a identidade estável da ordem/fornada. Repetir seu sinal não cria nova
  ocorrência. A ocorrência bloqueada por QC ou indisponibilidade não consome a assinatura.
...
o runbook orienta a ação sem oferecer reenvio cego.
