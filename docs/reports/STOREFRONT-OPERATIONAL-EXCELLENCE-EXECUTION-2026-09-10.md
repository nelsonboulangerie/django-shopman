...
- Base congelada inicial: `88314ff0474ba35c6dc69f58bbc2700b545454a4`. A referência local chamada `origin/main` estava recuada e não representava o GitHub. A `main` do GitHub foi buscada diretamente em 2026-09-11 e apontava para `1138c95eee0862630330328cf3bfe2f0b6424796`, com 248 commits ausentes da candidata. Os 25 commits finais da execução foram assentados sobre essa referência; conflitos foram resolvidos preservando os contratos operacionais mais recentes da `main` e incorporando os requisitos ainda necessários desta execução.
...
O diff técnico autorizado está concluído. G2 continua fechado apenas pelos itens que exigem observação ou ambiente autorizado: jornadas humanas estruturadas restantes, TalkBack adiado, retenção definitiva, providers/jobs reais e promoção do perfil de pre-go-live. Esses itens não são tratados como defeitos comprovados nem como autorização de rollout.
