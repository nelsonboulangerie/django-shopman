...
| `codex/marketing-r10-r12-replay-20260915` / `9d3eebb67` | Pronto somente local, validado | Replay seletivo de R10, R12 e R12/OTP sobre `943f437de`; 55 testes focados, cinco testes do dry-run, Ruff e `diff --check` passaram | Conservar local até #614 ter base definitiva; não abrir PR concorrente nem acionar CI agora | TTLs externos, classificação de tabelas, job monitorado, PostgreSQL/restore e autorização produtiva permanecem abertos |
