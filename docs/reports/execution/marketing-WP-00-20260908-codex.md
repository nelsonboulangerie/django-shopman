...
- quotas de API seguem 30/min user + 120/min shop para audience, 10/min user + 30/min shop para commands e, após recalibração humana de 2026-09-11, 10 operações lógicas/h user + 30/dia shop para fire; challenge, confirmação e replay com a mesma idempotency key contam uma vez, a reserva durável limita 5.000 targets externos/dia e `429` sempre traz `Retry-After`;
