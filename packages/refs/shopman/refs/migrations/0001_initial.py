    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_type', models.CharField(help_text='"{app_label}.{ModelName}" — ex: "orderman.Session"', max_length=64, verbose_name='tipo do alvo')),
                ...
                ('actor', models.CharField(blank=True, help_text='"system", "user:42", "lifecycle:commit"', max_length=128, verbose_name='ator')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['ref_type', 'value', 'is_active'], name='ref_type_val_active_idx'), models.Index(fields=['target_type', 'target_id', 'is_active'], name='ref_target_active_idx')],
            },
        ),
        migrations.CreateModel(
            name='RefSequence',
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('sequence_name', 'scope_hash'), name='refs_unique_sequence_scope')],
            },
        ),
    ]
