...
MESSAGE_TEMPLATES: dict[str, str] = {
    ...
    "order_ready_pickup": "Pedido {order_ref} pronto para retirada!{fiscal_note_suffix}",
    "order_ready_delivery": "Pedido {order_ref} pronto! Sera enviado em breve.{fiscal_note_suffix}",
    "order_dispatched": "Pedido {order_ref} saiu para entrega! Quando receber, confirme aqui: {tracking_url}{fiscal_note_suffix}",
    "order_delivered": "Pedido {order_ref} entregue. Obrigado!{fiscal_note_suffix}",
    "fiscal_note_ready": "Nota fiscal do pedido {order_ref}: {danfe_url}{fiscal_test_note}",
