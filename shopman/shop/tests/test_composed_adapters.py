...
def farinha(db):
    return Material.objects.create(
        sku="FARINHA-NOVARA-T55", name="Farinha T65", unit="kg", shelf_life_days=180,
    )
...
class TestComposedCatalogBackend:
    def test_resolves_product_then_material(self, croissant, farinha):
        ...
        ingredient = backend.get_product("FARINHA-NOVARA-T55")
...
class TestComposedSkuValidator:
    def test_get_sku_info_product_then_material(self, croissant, farinha):
        ...
        ing = v.get_sku_info("FARINHA-NOVARA-T55")
    ...
    def test_validate_skus_mixed(self, croissant, farinha):
        ...
        results = ComposedSkuValidator().validate_skus(["CROISSANT", "FARINHA-NOVARA-T55", "NOPE"])
        assert results["CROISSANT"].valid is True
        assert results["FARINHA-NOVARA-T55"].valid is True
    ...
    def test_get_sku_infos_mixed_matches_singular(self, croissant, farinha):
        ...
        v = ComposedSkuValidator()
        skus = ["CROISSANT", "FARINHA-NOVARA-T55", "NOPE"]
        ...
        assert batch["FARINHA-NOVARA-T55"].is_sellable is False
        assert batch["FARINHA-NOVARA-T55"].shelflife_days == 180
    ...
    def test_search_merges_and_dedups(self, croissant, farinha):
        ...
        assert "FARINHA-NOVARA-T55" in hits
