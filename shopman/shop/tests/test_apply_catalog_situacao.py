"""`apply_catalog_situacao` apaga o que o dono marcou `excluir` — e deixa a lápide.
...
def test_apagar_grava_a_lapide_com_a_prateleira_de_origem():
    ...
    call_command("apply_catalog_situacao", "--apply", stdout=None)
...
def test_o_ensaio_nao_grava_nem_a_lapide():
    ...
    call_command("apply_catalog_situacao", stdout=None)
