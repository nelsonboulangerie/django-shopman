    ...
    return [
        ...
        _group(
            ...
            [
                ...
                _model_item(
                    "Ações pendentes", "playlist_add_check", "orderman.Directive", query="?status__exact=queued"
                ),
...
def _model_item(
    title: str, icon: str, label: str, *, query: str = "", badge: str | None = None, badge_variant: str = "primary"
):
