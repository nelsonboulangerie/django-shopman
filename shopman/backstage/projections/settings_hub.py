...
SETTINGS_MAP: tuple[SettingsGroup, ...] = (
    SettingsGroup(
        ...
        entries=(
            ...
            _model("Integrações", "shop_shopintegrations", "Serviços externos: pagamento, mensagens, iFood, o mínimo de público das campanhas de WhatsApp e os limites de capacidade dos apps de operação.", "extension"),
        ),
    ),
    SettingsGroup(
        title="Como vendemos",
    ...
    SettingsGroup(
        ...
        entries=(
            ...
            _model("Maquininhas de entrega", "backstage_deliverydevice", "Identificação e disponibilidade das maquininhas que acompanham entregas.", "credit_card"),
    ...
    SettingsGroup(
        ...
        entries=(
            ...
            _model("Dispositivos confiáveis", "doorman_trusteddevice", "Dispositivos que dispensam nova verificação.", "devices"),
            _model(
                "Dispositivos com avisos",
                "shop_pushsubscription",
                "Inscrições Web Push por pessoa e aplicativo, sem expor as credenciais do dispositivo.",
