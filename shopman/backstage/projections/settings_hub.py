...
SETTINGS_MAP: tuple[SettingsGroup, ...] = (
    ...
    SettingsGroup(
        ...
        entries=(
            ...
            _model("Maquininhas de entrega", "backstage_deliverydevice", "Identificação e disponibilidade dos aparelhos que acompanham entregas.", "credit_card"),
    ...
    SettingsGroup(
        ...
        entries=(
            ...
            _model(
                "Aparelhos com avisos",
                "shop_pushsubscription",
                "Inscrições Web Push por pessoa e aplicativo, sem expor as credenciais do aparelho.",
