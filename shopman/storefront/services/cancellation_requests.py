...
Quando essa janela fecha, este módulo registra a intenção do cliente, entrega um
protocolo estável e encaminha a análise para o app de Pedidos. Não altera status,
pagamento ou estoque por conta própria.
"""
