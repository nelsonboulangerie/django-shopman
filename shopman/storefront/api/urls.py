...
from .account import (
    ...
    AccountExportView,
    AccountPasskeyDetailView,
    AccountPasskeyListView,
    AccountStepUpView,
    AccountSummaryView,
...
urlpatterns = [
    ...
    path("auth/passkey/register/options/", PasskeyRegisterOptionsView.as_view(), name="api-auth-passkey-register-options"),
    path("auth/passkey/register/", PasskeyRegisterView.as_view(), name="api-auth-passkey-register"),
