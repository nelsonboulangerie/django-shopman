"""Concierge: venda conversacional sobre o Shopman.
...
- ``agent``     — o laço com o modelo: prompt, janela de memória, chamadas de
                  ferramenta, orçamento de tokens. Não conhece HTTP nem provedores.
...
- ``contracts`` — envelope, capacidades e resultados comuns a qualquer transporte.
- ``transport`` — registro de conexões e adapters de provedores e canais.
