...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      ...
      link: [
        ...
        { rel: 'icon', href: '/pwa/favicon.svg?v=7', type: 'image/svg+xml' },
  ...
  pwa: {
    ...
    workbox: {
      ...
      // `legal/` é o arquivo permanente de Termos/Privacidade citado pelos pedidos:
      // abre por link, uma versão cresce a cada revisão e nenhuma precisa estar offline.
      globIgnores: ['pwa/screenshots/**', 'legal/**'],
