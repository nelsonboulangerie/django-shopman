...
export function buildStorefrontManifest (shop: PwaShopSource = {}) {
  ...
  return {
    ...
    icons: [
      { src: '/pwa/pwa-64x64.png?v=7', sizes: '64x64', type: 'image/png', purpose: 'any' },
      { src: '/pwa/pwa-192x192.png?v=7', sizes: '192x192', type: 'image/png', purpose: 'any' },
      ...
      { src: '/pwa/monochrome-512x512.png?v=7', sizes: '512x512', type: 'image/png', purpose: 'monochrome' }
    ],
    shortcuts: [
      { name: 'Cardápio', short_name: 'Cardápio', url: '/menu', icons: [{ src: '/pwa/pwa-192x192.png?v=7', sizes: '192x192' }] },
      { name: 'Sacola', short_name: 'Sacola', url: '/sacola', icons: [{ src: '/pwa/pwa-192x192.png?v=7', sizes: '192x192' }] },
      { name: 'Meus pedidos', short_name: 'Pedidos', url: '/conta', icons: [{ src: '/pwa/pwa-192x192.png?v=7', sizes: '192x192' }] }
    ],
    screenshots: [
