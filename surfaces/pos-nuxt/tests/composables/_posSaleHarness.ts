...
export function makeProjection(overrides: Partial<POSProjection> = {}): POSProjection {
  return {
    products: [
      { sku: "PAO", name: "Pão", price_q: 500, price_display: "R$ 5,00", collection_ref: "padaria", image_url: "" },
      { sku: "CAFE", name: "Café", price_q: 300, price_display: "R$ 3,00", collection_ref: "bebidas", image_url: "" },
    ],
    collections: [],
    payment_methods: [
