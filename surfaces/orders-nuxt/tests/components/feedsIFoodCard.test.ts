...
vi.stubGlobal("useFeedBoard", () => ({ board, error: ref(null), errorMsg: ref(""), pending: ref(false), refresh: vi.fn(), isBusy: () => false, setCollections: vi.fn(), setActive: vi.fn(), setRotation: vi.fn() }));
