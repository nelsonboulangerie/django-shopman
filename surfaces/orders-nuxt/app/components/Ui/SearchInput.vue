...
<template>
  <div class="relative">
    ...
    <input
      ...
      class="h-control w-44 rounded-md border bg-card pl-8 pr-12 text-sm outline-none transition-[width,box-shadow] focus:w-56 focus:ring-1 focus:ring-ring sm:w-52 sm:focus:w-64"
