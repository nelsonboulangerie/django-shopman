...
//
// A trava é por DISPOSITIVO: o operador escolhe travar na orientação em que o tablet
...
/** Estado visível da trava: travada, livre, ou recusada pelo dispositivo/contexto. */
 ...
 * contexto: fora do app instalado a saída é instalar; dentro dele, o dispositivo não
