...
SHOPMAN_MANYCHAT = {
    ...
    "whatsapp_id_field_id": MANYCHAT_WHATSAPP_ID_FIELD_ID,
...
# ── Meta Campaign (FOMO — posting IG + FB via Graph API) ────────────
# Adapter F5 da Campanha: publica conteúdo no Instagram (IG Content Publishing
    ...
    "TABS": [
        {
            ...
            "items": [
                {"title": "Regras de preço", "link": reverse_lazy("admin:shop_ruleconfig_changelist")},
                {"title": "Promoções", "link": reverse_lazy("admin:shop_promotion_changelist")},
                {"title": "Cupons", "link": reverse_lazy("admin:shop_coupon_changelist")},
            ],
        },
        {
            "models": ["shop.deliveryzone", "shop.deliverydistanceband"],
            "items": [
                {"title": "Zonas de entrega", "link": reverse_lazy("admin:shop_deliveryzone_changelist")},
                {"title": "Faixas de distância", "link": reverse_lazy("admin:shop_deliverydistanceband_changelist")},
            ],
        },
        {
...
SHOPMAN_FOCUS_NFE = {
    ...
    # CFOP da produção própria (5101, revisto em 24/09/2026). Mesmo valor do perfil
    # `own_production` em shopman.fiscalman.classification —
    # docs/reference/fiscal-cfop-5101-vs-5102.md.
    "default_cfop_nfce": os.environ.get("FOCUS_NFE_NFCE_DEFAULT_CFOP", "5101"),
